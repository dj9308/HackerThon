...
# 난이도** 2. python standard librry에 'requests'가 있나요? : 접근 및 list in
# 출력예시)
# false
...
# python
# web
print(T4IR_5th['language'].values())
...
# 출력예시)
# 오늘의 당번은 ???
random = random.sample(T4IR_5th['members']['1304']['groups']['4조'],1)
for i in random:
    print('오늘의 당번은 : '+f'{i}')
